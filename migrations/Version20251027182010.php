 ...
 */
final class Version20251027182010 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blogpost CHANGE date created_at DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blogpost CHANGE created_at date DATETIME NOT NULL');
    }
}
